...
namespace CarTuning
{
    public class CarTuning_FrontLightState : CarTuning_StateBase
    {
        [SerializeField] private List<CarPart_WithAnimation> _wheels = new();

        public override async Task Enable()
        {
            _wheels = _model.currentCar.value.frontLight_Position.GetComponentsInChildren<CarPart_WithAnimation>(true).ToList();
