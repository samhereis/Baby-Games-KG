...
{
    public class GameplayGameState_Makeup_Model
    {
        public Action goToMainMenuRequest;
        public Action goToNextActivityRequest;
        public Action replayRequest;
        public Action completeButtonShowRequested;
        public Action onCompleteButtonClicked;
        ...
        public MakeupActivity_Identifier activityIdentifier { get; set; }
        public Makeup_Controller princessController { get; set; }
        ...
        public GameplayGameState_Makeup_Model(Activity newActivity)
        {
