...
namespace PaintIn2D
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitScreenFill2D")]
	[AddComponentMenu(PaintCore.CwCommon.ComponentHitMenuPrefix + "Hit Screen Fill 2D")]
	public class CwHitScreenFill2D : CwHitScreen2D
	{
...
{
	using UnityEditor;
	using TARGET = CwHitScreenFill2D;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitScreenFill2D_Editor : CwHitScreen2D_Editor
	{
