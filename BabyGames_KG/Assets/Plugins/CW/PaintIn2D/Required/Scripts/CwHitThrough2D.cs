...
namespace PaintIn2D
{
	...
	[ExecuteInEditMode]
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitThrough2D")]
	[AddComponentMenu(PaintCore.CwCommon.ComponentHitMenuPrefix + "Hit Through 2D")]
	public class CwHitThrough2D : MonoBehaviour
	{
...
{
	using UnityEditor;
	using TARGET = CwHitThrough2D;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitThrough2D_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			BeginIndent();
				if (Any(tgts, t => t.Orientation == CwHitThrough2D.OrientationType.CameraUp))
				{
