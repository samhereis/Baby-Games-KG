...
namespace Zenject
{
    public class SceneContext : RunnableContext
    {
        ...
        [FoldoutGroup("Events")] public UnityEvent OnPreInstall;
        [FoldoutGroup("Events")] public UnityEvent OnPostInstall;
        [FoldoutGroup("Events")] public UnityEvent OnPreResolve;
        [FoldoutGroup("Events")] public UnityEvent OnPostResolve;
